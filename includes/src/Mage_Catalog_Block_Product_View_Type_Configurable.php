    ...
    public function getJsonConfig()
    {
        ...
        foreach ($this->getAllowProducts() as $product) {
            ...
            foreach ($this->getAllowAttributes() as $attribute) {
				...
				$options[$productAttribute->getId()][$attributeLabel][$productId] = $qty;
				//end
            }
        }
            ...
            if (is_array($prices)) {
                foreach ($prices as $value) {
                    ...
                    $info['options'][] = array(
						...
						'qty'    => isset($options[$attributeId][$value['label']]) ? $options[$attributeId][$value['label']] : array(), //ADD THIS LINE
